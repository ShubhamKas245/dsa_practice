...
// Example Explanation
// Explanation 1: => After performing the operations, the array becomes [1, 1, 7].
// The XOR of all the elements of this array is 7.There can be other possible arrays,but we can prove that the XOR will always be 7.
// Explanation 2: => Since all the elements are equal. Even after applying the operations in any order, the array will be [1, 1, 1].
